            ...
            >
              <div className="mb-12">
                <div className="w-32 h-32 mx-auto lg:mx-0 mb-6 bg-gradient-to-br from-purple-600 to-blue-600 rounded-full flex items-center justify-center overflow-hidden">
                  <img src="/hijabi-girl-aesthetic.jpg" alt="Iqra Urooj" className="w-28 h-28 object-cover rounded-full" />
                </div>
                <h2 className="text-3xl font-black mb-2">Iqra Urooj</h2>
                <p className="text-purple-300 text-lg">Full Stack Developer & Designer</p>
              </div>
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-purple-200">uroojiqra58@gmail.com</p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-purple-200">03429813925</p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-purple-200">Dera Ismail Khan (KPK) Pak</p>
                  </div>
                </motion.div>
              </div>
